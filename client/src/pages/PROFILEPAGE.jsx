    ...
    const handlesubmit=async(e)=>{
        ...
        return 
            ...
            render.onload=async()=>{
                ...
                await update({profilePic:base64Image,name,bio})
                navigate('/')
        return 
            }
        }
        ...
        <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
            ...
            ? URL.createObjectURL(selectedImg)
             :avatar_icon} alt="" className={`w-12 h-12 ${selectedImg && 'rounded-full'}`} />
                ...
                <img src={authUser.profilePic||logo_icon} alt="" className='max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 '/>
            </div>
